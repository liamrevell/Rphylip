...
\begin{description}
\raggedright{}
\item[Version]\AsIs{0.1-08}
\item[Date]\AsIs{2013-12-9}
...
\item[Date/Publication]\AsIs{2013-12-9 12:00:00 EDT}
\end{description}
...
\keyword{phylogenetics}{as.proseq}
\keyword{inference}{as.proseq}
\keyword{maximum likelihood}{as.proseq}
%
\begin{Description}\relax
...
\keyword{phylogenetics}{print.proseq}
\keyword{inference}{print.proseq}
\keyword{maximum likelihood}{print.proseq}
%
\begin{Description}\relax
...
%
\begin{SeeAlso}\relax
\code{\LinkA{as.proseq}{as.proseq}}, \code{\LinkA{Rproml}{Rproml}}
\end{SeeAlso}
\inputencoding{utf8}
...
\keyword{inference}{read.protein}
\keyword{maximum likelihood}{read.protein}
%
\begin{Description}\relax
...
%
\begin{SeeAlso}\relax
\code{\LinkA{Rdnaml}{Rdnaml}}, \code{\LinkA{Rcontml}{Rcontml}}
\end{SeeAlso}
\inputencoding{utf8}
